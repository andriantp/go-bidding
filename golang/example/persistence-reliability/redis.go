...
// ======================== Save ========================
func SaveBidEvent(bid Bid) error {
...
// ======================== Atomic Validation ========================
func ValidateBidAtomicWithRetry(bid Bid) error {
	maxRetry := 3
...
// ======================== Recovery ========================
func RecoverStateFromStream() error {
	streams, err := rdb.XRange(
		ctx,
		Stream,
		"-",
	...
	fmt.Println(
		"recovered highest bid:",
		highestBid,
	)

	fmt.Println(
		"recovered highest bidder:",
		highestBidder,
	)
